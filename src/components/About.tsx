        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center max-w-6xl mx-auto">
          ...
          <div className="relative flex justify-center fade-in-digital">
            <div className="relative">
              ...
              <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-full border-4 border-primary/50 overflow-hidden bg-gradient-to-br from-card to-muted shadow-2xl">
                <img 
                  src={profilePhoto} 
                  alt="Roshan Devkota" 
                ...
                <div className="absolute top-3 left-3 md:top-6 md:left-6 w-8 h-8 md:w-12 md:h-12 border-l-4 border-t-4 border-primary rounded-tl-lg" />
                <div className="absolute top-3 right-3 md:top-6 md:right-6 w-8 h-8 md:w-12 md:h-12 border-r-4 border-t-4 border-primary rounded-tr-lg" />
                <div className="absolute bottom-3 left-3 md:bottom-6 md:left-6 w-8 h-8 md:w-12 md:h-12 border-l-4 border-b-4 border-primary rounded-bl-lg" />
                <div className="absolute bottom-3 right-3 md:bottom-6 md:right-6 w-8 h-8 md:w-12 md:h-12 border-r-4 border-b-4 border-primary rounded-br-lg" />
                
                {/* Status indicators */}
                <div className="absolute top-2 md:top-4 left-1/2 transform -translate-x-1/2 flex gap-2">
              ...
              <div className="absolute top-1/2 left-1/2 w-80 h-80 md:w-96 md:h-96 border border-accent/20 rounded-full -translate-x-1/2 -translate-y-1/2 animate-spin" style={{ animationDuration: '20s' }} />
              <div className="absolute top-1/2 left-1/2 w-96 h-96 md:w-[28rem] md:h-[28rem] border-dashed border-tech-cyan/20 rounded-full -translate-x-1/2 -translate-y-1/2 animate-spin" style={{ animationDuration: '15s', animationDirection: 'reverse' }} />
            </div>
          </div>

          {/* Enhanced About Content */}
          <div className="space-y-6 md:space-y-8 fade-in-digital" style={{ animationDelay: '0.3s' }}>
            <Card className="skill-card p-6 md:p-8 relative overflow-hidden">
              {/* Enhanced circuit patterns */}
              <div className="absolute top-0 right-0 w-24 h-24 md:w-32 md:h-32 border-l-2 border-b-2 border-primary/20 rounded-bl-3xl" />
              <div className="absolute bottom-0 left-0 w-20 h-20 md:w-24 md:h-24 border-r-2 border-t-2 border-accent/20 rounded-tr-3xl" />
              
              <div className="space-y-4 md:space-y-6">
                <h3 className="text-2xl md:text-3xl font-bold text-primary mb-4 md:mb-6 flex items-center gap-2 md:gap-3">
                ...
                <div className="space-y-4 md:space-y-6 text-foreground leading-relaxed">
                  <div className="p-3 md:p-4 bg-muted/30 rounded-lg border-l-4 border-primary/50 font-mono text-xs md:text-sm">
                  ...
                  {/* Enhanced stats grid */}
                  <div className="grid grid-cols-3 gap-3 md:gap-4 mt-6 md:mt-8 pt-4 md:pt-6 border-t border-primary/20">
                    <div className="text-center p-3 md:p-4 bg-gradient-to-br from-primary/10 to-accent/10 rounded-lg">
                      <div className="text-xl md:text-2xl font-bold text-primary">2019</div>
                      <div className="text-xs md:text-sm text-muted-foreground font-mono">GRADUATED</div>
                    </div>
                    <div className="text-center p-3 md:p-4 bg-gradient-to-br from-accent/10 to-tech-cyan/10 rounded-lg">
                      <div className="text-xl md:text-2xl font-bold text-accent">4+</div>
                      <div className="text-xs md:text-sm text-muted-foreground font-mono">YEARS_EXP</div>
                    </div>
                    <div className="text-center p-3 md:p-4 bg-gradient-to-br from-tech-cyan/10 to-primary/10 rounded-lg">
                      <div className="text-xl md:text-2xl font-bold text-tech-cyan">∞</div>
                      <div className="text-xs md:text-sm text-muted-foreground font-mono">LEARNING</div>
                    </div>
                  </div>
                </div>
              </div>
